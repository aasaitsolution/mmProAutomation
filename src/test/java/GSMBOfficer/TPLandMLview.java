...
public class TPLandMLview extends BaseTest {
    ...
    public void testViewMiningLicense() {
        navigateToTab("//*[@id=\"root\"]/div/main/div/div[2]/div[1]/div[1]/div/div[3]");
    ...
    public void testViewTransportLicense() {
        navigateToTab("//*[@id=\"root\"]/div/main/div/div[2]/div[1]/div[1]/div/div[2]");
        WebElement viewButton = wait.until(ExpectedConditions.elementToBeClickable(
    ...
    public void testComplaintsPagination() {
        navigateToTab("//*[@id=\"root\"]/div/main/div/div[2]/div[1]/div[1]/div/div[4]");
    ...
    private void navigateToTab(String tabXpath) {
    ...
    private void testPagination(String buttonXpath) {
        try {
            ...
            System.out.println("Pagination button not found: " + buttonXpath);
        }
    }
